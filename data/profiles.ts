...
const img = (id: string, w = 600, h = 900) =>
  `https://images.unsplash.com/${id}?w=${w}&h=${h}&fit=crop&crop=faces,top&auto=format&q=85`;
...
export const profiles: User[] = [
  {
    ...
    photos: [
      ...
      img('photo-1524504388940-b1c1722653e1', 600, 500),
    ],
    prompts: [
  ...
  },
  {
    ...
    photos: [
      ...
      img('photo-1506794778202-cad84cf45f1d', 600, 500),
    ],
    prompts: [
  ...
  },
  {
    ...
    photos: [
      ...
      img('photo-1488426862026-3ee34a7d66df', 600, 500),
    ],
    prompts: [
  ...
  },
  {
    ...
    photos: [
      ...
      img('photo-1519085360753-af0119f7cbe7', 600, 500),
    ],
    prompts: [
  ...
  },
  {
    ...
    photos: [
      ...
      img('photo-1534528741775-53994a69daeb', 600, 500),
    ],
    prompts: [
  ...
  },
  {
    ...
    photos: [
      ...
      img('photo-1504257432389-52343af06ae3', 600, 500),
    ],
    prompts: [
  ...
  },
  {
    ...
    photos: [
      ...
      img('photo-1529626455594-4ff0802cfb7e', 600, 500),
    ],
    prompts: [
