...
export const incomingSparks: IncomingSpark[] = [
  {
    ...
    cupidName: 'Aria K.',
    note: 'You both love Sunday farmers markets and cooking — Jordan mentioned wanting someone to try new recipes with.',
    vibe: 'strong',
    aiVerified: true,
  },
  {
  ...
  },
  {
    ...
    cupidName: 'Lena M.',
    note: 'Kai is low-key and genuine, you seem the same way. "Comfortable silence" energy — I think you\'d actually just get each other.',
    vibe: 'soulmates',
    aiVerified: false,
  },
  {
